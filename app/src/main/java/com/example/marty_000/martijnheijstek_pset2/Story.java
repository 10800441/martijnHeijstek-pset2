...
/*
 * com.example.marty_000.martijnheijstek_pset2.Story.java
 * Madlibs
 *
...
public class  Story implements Serializable {
    ...
    /** constructs a new com.example.marty_000.martijnheijstek_pset2.Story reading its text from the given input stream */
